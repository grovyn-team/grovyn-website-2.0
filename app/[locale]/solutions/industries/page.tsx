...
export default async function SolutionsIndustriesPage() {
  ...
  return (
    <div className="bg-white">
      <section className="min-h-[60vh] sm:min-h-[65vh] lg:min-h-[70vh] flex flex-col justify-center bg-black text-white pt-28 pb-24 px-6 lg:px-12 rounded-b-[3rem] relative overflow-hidden">
