...
export default function MobileServiceContent() {
  ...
  return (
    <div className="bg-[#050505] text-white min-h-screen pt-0 overflow-x-hidden selection:bg-[#10b981] selection:text-black font-sans">
      <section className="relative min-h-[60vh] sm:min-h-[65vh] lg:min-h-[70vh] flex flex-col justify-center py-15 sm:py-15 lg:py-24 px-4 sm:px-6 lg:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center relative z-10">
          ...
          <div className="relative group hidden lg:block">
            ...
            <div className="relative bg-white/5 border border-white/10 rounded-[4rem] p-5 sm:p-6 backdrop-blur-3xl shadow-2xl transform transition-transform duration-1000 group-hover:rotate-1 group-hover:scale-[1.02]">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-5">
                <div className="bg-white/5 p-4 sm:p-5 rounded-[2rem] border border-white/5 space-y-2 hover:bg-white/10 transition-colors">
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">App Launch</span>
                  <div className="text-4xl sm:text-5xl font-black text-[#10b981] tracking-tighter">0.8s</div>
                </div>
                <div className="bg-white/5 p-4 sm:p-5 rounded-[2rem] border border-white/5 space-y-2 hover:bg-white/10 transition-colors">
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">Frame Rate</span>
                  <div className="text-4xl sm:text-5xl font-black text-[#10b981] tracking-tighter">60 FPS</div>
                </div>
              </div>

              <div className="h-52 sm:h-56 w-full bg-black/60 rounded-[2rem] border border-white/5 overflow-hidden relative group/img">
                <Image
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12 bg-white text-black relative">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-8 sm:mb-12 lg:mb-16 gap-6 sm:gap-8 lg:gap-10">
            <div className="space-y-4 sm:space-y-6">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black tracking-tighter leading-[0.85]">
                Engineered <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-4 lg:gap-6 md:auto-rows-[380px]">
            <div className="md:col-span-8 group relative bg-[#050505] rounded-xl md:rounded-[4rem] p-4 md:p-6 lg:p-8 xl:p-10 overflow-hidden flex flex-col justify-between transition-all duration-700 shadow-2xl border border-white/5 hover:scale-[1.01] min-h-[240px] md:min-h-0 pb-5 md:pb-6">
              ...
              <div className="relative z-10 flex justify-between items-start">
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-center space-x-2 md:space-x-4">
                    <div className="w-10 h-10 md:w-14 md:h-14 rounded-lg md:rounded-xl bg-[#10b981] flex items-center justify-center text-black shadow-[0_0_40px_rgba(16,185,129,0.3)]">
                      <Zap size={18} strokeWidth={2.5} className="md:w-7 md:h-7" />
                    </div>
                    <div className="space-y-0.5">
                      <span className="text-[7px] md:text-[9px] font-mono text-[#10b981] uppercase tracking-[0.2em] block">Execution_Matrix</span>
                      <div className="text-white text-[8px] md:text-[10px] font-black uppercase tracking-widest">Battery Optimized Execution</div>
                    </div>
                  </div>
                ...
                <div className="hidden lg:block space-y-4">
                  <div className="text-right">
                    <div className="text-xl md:text-2xl font-black text-white">0.8s</div>
                    <div className="text-[9px] font-mono text-gray-500 uppercase tracking-widest mt-0.5">First_Meaningful_Paint</div>
                  </div>
                  <div className="h-32 w-44 bg-white/5 rounded-2xl border border-white/10 p-5 flex flex-col items-center justify-center group-hover:border-[#10b981]/40 transition-colors">
                    <Activity size={40} className="text-[#10b981] animate-pulse" />
                    <span className="text-[8px] font-mono text-white/20 uppercase mt-2">UI_THREAD_READY</span>
                  </div>
                </div>
              </div>

              <div className="relative z-10 flex items-center space-x-2 md:space-x-4 mt-2 md:mt-0">
                <div className="flex items-center space-x-1.5 text-[8px] md:text-[10px] font-mono text-[#10b981] font-black uppercase tracking-widest">
            ...
            <div className="md:col-span-4 bg-[#10b981] rounded-xl md:rounded-[4rem] p-4 md:p-6 lg:p-8 flex flex-col justify-between items-center relative overflow-hidden group hover:scale-[1.03] transition-all duration-700 min-h-[200px] md:min-h-0">
              ...
              <div className="relative z-10 w-full flex justify-between items-start">
                <div className="w-7 h-7 md:w-10 md:h-10 rounded-lg md:rounded-xl bg-black/10 backdrop-blur-xl flex items-center justify-center text-black">
                  <Radar size={12} className="md:w-5 md:h-5" />
                </div>
                <div className="text-right">
                  <span className="text-[6px] md:text-[8px] font-black uppercase tracking-widest text-black/40">Reliability</span>
                  <span className="text-[7px] md:text-[9px] font-bold text-black block mt-0.5">TIER_1</span>
                </div>
              </div>

              <div className="relative z-10 text-center">
                <h3 className="text-xs md:text-sm font-black text-black uppercase tracking-wider mb-1.5">Stability at Scale</h3>
                <div className="text-xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-tighter text-black leading-none mb-1.5 md:mb-4 drop-shadow-xl">99%+</div>
              ...
              <div className="relative z-10 w-full text-center">
                <p className="text-black/60 font-medium text-[8px] md:text-[10px] leading-relaxed px-2">
                  Built with production monitoring, staged rollouts, and crash prevention patterns designed for growing usage.
                </p>
              </div>
            </div>

            <div className="md:col-span-5 bg-[#0a0a0a] rounded-xl md:rounded-[4rem] p-4 md:p-6 lg:p-8 xl:p-10 text-white flex flex-col justify-between relative overflow-hidden group hover:bg-[#111] transition-all min-h-[220px] md:min-h-0 pb-5 md:pb-6">
              ...
              <div className="relative z-10 flex justify-between items-start">
                <div className="w-9 h-9 md:w-14 md:h-14 rounded-lg md:rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#10b981]">
                  <ShieldCheck size={16} className="md:w-8 md:h-8" />
                </div>
                <div className="text-right">
                  <span className="text-[6px] md:text-[8px] font-mono text-gray-500 uppercase tracking-widest block">Biometric_Protocol</span>
                  <span className="text-[7px] md:text-[9px] font-black text-[#10b981] tracking-widest">ENCRYPTED</span>
                </div>
              </div>
              ...
              <div className="absolute bottom-8 right-8 opacity-[0.03] group-hover:opacity-[0.08] transition-all duration-700 hidden md:block">
                <ScanFace size={180} />
              </div>
            </div>

            <div className="md:col-span-7 bg-[#f8f9fa] border border-gray-100 rounded-xl md:rounded-[4rem] p-4 md:p-6 lg:p-8 xl:p-10 flex flex-col lg:flex-row items-center justify-between group hover:border-[#10b981]/40 transition-all duration-700 relative overflow-hidden shadow-inner min-h-[240px] md:min-h-0">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,_rgba(16,185,129,0.03)_0%,_transparent_70%)]"></div>

              <div className="relative z-10 space-y-4 md:space-y-6 lg:space-y-8 flex-grow">
                <div className="space-y-2 md:space-y-4">
                  <div className="flex items-center space-x-2 text-[7px] md:text-[9px] font-black text-[#10b981] uppercase tracking-[0.4em]">
                    <AppWindow size={10} className="md:w-3 md:h-3" />
                    <span>Native_API_Integration</span>
                  </div>
                  <h3 className="text-sm md:text-xl lg:text-2xl xl:text-3xl font-black text-black tracking-tighter leading-[0.9]">Native <br />Ecosystem.</h3>
                  <p className="text-gray-500 text-[9px] md:text-xs lg:text-sm font-medium max-w-sm leading-relaxed line-clamp-2 md:line-clamp-none">
                ...
                <div className="flex space-x-4 md:space-x-8">
                  <div className="space-y-0.5">
                    <div className="text-base md:text-xl font-black text-black tracking-tight">100%</div>
                    <div className="text-[6px] md:text-[8px] font-black uppercase tracking-widest text-gray-400">code ownership</div>
                  </div>
                  <div className="w-[1px] h-8 md:h-12 bg-gray-200"></div>
                  <div className="space-y-0.5">
                    <div className="text-base md:text-xl font-black text-black tracking-tight">Full</div>
                    <div className="text-[6px] md:text-[8px] font-black uppercase tracking-widest text-gray-400">hardware access</div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-black text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-20 lg:mb-24 space-y-4 sm:space-y-6">
            ...
            <h2 className="text-3xl sm:text-3xl lg:text-3xl xl:text-[3.5rem] font-black tracking-[-0.05em] leading-[0.9]">Mobile Lifecycle.</h2>
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            <div className="hidden lg:block col-span-4 h-0 relative overflow-visible">
              <div className="absolute top-[3rem] left-0 right-0 h-[2px] bg-gradient-to-r from-[#10b981]/30 via-[#10b981]/20 to-[#10b981]/30">
              ...
              {[
                ...
                <div key={i} className="group relative">
                  <div className="hidden lg:flex absolute top-[3rem] left-1/2 -translate-x-1/2 w-3.5 h-3.5 rounded-full bg-black border-2 border-[#10b981] z-20 group-hover:bg-[#10b981] transition-all duration-500 shadow-[0_0_15px_rgba(16,185,129,0.3)]"></div>
                  <div className="bg-white/5 border border-white/5 rounded-[2.5rem] p-6 lg:p-8 pt-12 lg:pt-14 space-y-5 transition-all duration-700 hover:bg-white/10 hover:border-[#10b981]/30 hover:-translate-y-2 group">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <div className="text-[9px] font-mono text-[#10b981] uppercase tracking-[0.3em]">{step.phase}</div>
                        <div className="text-[9px] font-mono text-white/20 uppercase">PHASE_{step.id}</div>
                      </div>
                      <div className="w-12 h-12 rounded-xl bg-black border border-white/10 flex items-center justify-center text-[#10b981] group-hover:bg-[#10b981] group-hover:text-black transition-all shadow-xl">
                        {step.icon}
                      </div>
                    ...
                    <div className="pt-4 border-t border-white/5 space-y-2 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                      {step.tasks.map((task, idx) => (
                        <div key={idx} className="flex items-center space-x-2">
                          <div className="w-1 h-1 rounded-full bg-[#10b981]"></div>
                          <span className="text-[9px] font-black uppercase tracking-widest text-gray-400">{task}</span>
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      <section className="py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12 bg-white text-black">
        <div className="max-w-4xl mx-auto">
